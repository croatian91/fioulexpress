...
DistribTarifFioulForm = inlineformset_factory(
    Zone,
    TarifFioul,
    exclude=("type_fioul",),
    extra=0,
...
DistribTarifDecoteForm = inlineformset_factory(
    Zone,
    TarifDecote,
    exclude=(
        "min",
...
DistribTarifLivraisonForm = inlineformset_factory(
    Zone,
    TarifLivraison,
...
class DistribDalForm(forms.ModelForm):
    distributeur = forms.ModelChoiceField(
        widget=autocomplete.ModelSelect2(url="distributeur-autocomplete"),
