...
def get_iframe_src(panier, request):
    texte_libre = "%s %s %s" % (
        panier.adresse_livraison.prenom,
        panier.adresse_livraison.nom,
        panier.client.email,
    )
    ...
    data = {
        ...
        "contexte_commande": base64.b64encode(
            contexte_commande.encode("utf-8")
        ).decode(),
        ...
        "url_retour_err": "https://%s/commande/monetico_ko/"
